...
("Nellie Moss", "MATH", '04'), 
("Dan Warner", "BIO", '01'), 
("Melvin Colon", "MATH", '03'), 
("Irma Arnold", "MATH", '03'), 
("Kim Rios", "CS", '03'), 
("Aubrey Cunningham", "BIO", '01'), 
("Danielle Poole", "CS", '01'), 
("Christine Johnson", "MATH", '00'), 
("Jeannie Perry", "BIO", '04'), 
("Guadalupe Crawford", "MATH", '03'), 
("Natasha Mckenzie", "MATH", '03'), 
("Brandy Pearson", "CS", '00'), 
("Calvin Harrington", "BIO", '01'), 
("Beatrice Page", "CS", '02'), 
("Jermaine Martin", "CS", '01'), 
("Della Sutton", "CS", '02'), 
("Joseph Luna", "BIO", '01'), 
("Pat Davidson", "BIO", '02'), 
("Shelly Love", "BIO", '02'), 
("Felicia Lopez", "MATH", '00'), 
("Nick Wade", "CS", '03'), 
("Patricia Porter", "BIO", '03'), 
("Manuel Weaver", "MATH", '04'), 
("Gwendolys Rowe", "MATH", '02'), 
("Nicholas Williams", "BIO", '01'), 
("Martin Parks", "CS", '01'), 
("Shari Sullivan", "BIO", '04'), 
("Kristina Singleton", "CS", '02'), 
("Sammy Benson", "CS", '01'), 
("Ronnie Armstrong", "BIO", '01'), 
("Louis Hayes", "MATH", '02'), 
("Mitchell Lyons", "BIO", '02'), 
("Pamela Jenkins", "MATH", '01'), 
("Nathaniel Reyes", "MATH", '01'), 
("Olga Gom", "CS", '01'), 
("Sylvester Adkins", "MATH", '00'), 
("Jesse Lynch", "MATH", '02'), 
("Jenny Perkins", "CS", '04'), 
("Lena Wise", "MATH", '03'), 
("Cecelia Paul", "BIO", '02'), 
("Mable Bell", "BIO", '03'), 
("Mamie Ramos", "MATH", '02'), 
("Clay Fitzgerald", "MATH", '00'), 
("Kristine Jennings", "BIO", '01'), 
("Tanya Ross", "CS", '02'), 
("Garry White", "CS", '02'), 
("Lamar Price", "BIO", '04'), 
("Alberto Mason", "MATH", '04'), 
("Warren Payne", "MATH", '03'), 
("Lloyd Coleman", "BIO", '03'), 
("May Patton", "CS", '01'), 
("Ralph Massey", "CS", '02'), 
("Krystal Reynolds", "BIO", '01'), 
("Virgil Bush", "MATH", '03'), 
("Louise Brewer", "BIO", '01'), 
("Carmen Bowman", "MATH", '01'), 
("Ramirez Garza", "BIO", '03'), 
("Devin Richardson", "MATH", '01'), 
("Nadine Stevens", "CS", '01'), 
("Harriet Brock", "BIO", '02'), 
("Russell Reeves", "MATH", '01'), 
("Carlton Burns", "BIO", '01'), 
("Randal Garrett", "CS", '03'), 
("Maria Mcgee", "BIO", '01'), 
("Alexandra Mcbride", "BIO", '03'), 
("Cameron Wells", "BIO", '03'), 
("Cecil Russell", "BIO", '00'), 
("Mike Hampton", "CS", '02'), 
("Lucille Klein", "BIO", '00'), 
("Trevor Gutierrez", "BIO", '00'), 
("Kay Gibbs", "CS", '03'), 
("Elvira Santiago", "CS", '01'), 
("Janet Cole", "MATH", '02'), 
("Margaret Lindsey", "MATH", '01'), 
("Mich Court", "MATH", '03'), 
("Lauren Harper", "MATH", '03'), 
("Lorena Rice", "BIO", '01'), 
("Vicky Grant", "MATH", '02'), 
("Jerry Carr", "CS", '01'), 
("Lucas Hubbard", "CS", '02'), 
("Carolyn Silva", "MATH", '00'), 
("Steve Curry", "BIO", '00'), 
("Lewis Marshall", "BIO", '01'), 
("Jesus Mack", "BIO", '02'), 
("Roxanne Aguilar", "BIO", '02'), 
("Bert Welch", "BIO", '02'), 
("Justin Lewis", "CS", '01'), 
("Bob Rose", "MATH", '04'), 
...
(111004, 10, 'F'), (111062, 6, 'D'), (111069, 1, 'B'), (111025, 6, 'A'), (111055, 9, 'A'), (111086, 5, 'C'), (111079, 9, 'C'),
(111049, 7, 'C'), (111048, 3, 'B'), (111042, 7, 'C'), (111004, 6, 'A'), (111053, 5, 'B'), (111066, 6, 'A'), (111004, 9, 'D'),
